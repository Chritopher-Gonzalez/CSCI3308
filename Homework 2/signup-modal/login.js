function openModal() {
  ...
  console.log(letter.classList)
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = (confirmMyInput.value.match(document.getElementById("psw").value)); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (length.classList.value == "valid" && capital.classList.value == "valid" && number.classList.value == "valid" && length.classList.value == "valid" && match.classList.value == "valid"); // TODO: Replace false with the correct condition
    console.log(condition);
    //console.log('other:'length.classList.value == "valid" && capital.classList.value == "valid" && number.classList.value == "valid" && length.classList.value == "valid" && match.classList.value == "vaild");
    if(condition) {
